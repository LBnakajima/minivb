...
import TeamNotCreatedModal from "../modals/TeamNotCreatedModal";
...
const Top = () => {
  ...
  const fetchParticipationData = useCallback(async () => {
    ...
    if (!querySnapshot.empty) {
      ...
      setTeamStatus(teamDoc.data().status);
  ...
  return (
    <div className="fixed inset-0 bg-white">
      <div className="relative min-h-screen">
        <div className="fixed top-0 left-0 w-full py-8 z-0 flex items-center justify-between px-4">
        ...
        <div className="flex flex-col items-center mt-12">
          ...
          <div className="grid grid-cols-2 gap-4 w-full px-4">
            {participants.map((participant) => (
              <div
                key={participant.id}
                className={`px-4 py-2 rounded text-center border ${
